                            ...
                            <div class="space-y-4 p-4">
                                ...
                                @forelse($cards as $atributoId => $card)
                                    ...
                                    {{-- ==================================================
                                        ...
                                        ================================================== --}}
                                    <div
                                        wire:key="categoria-atributo-card-{{ $atributoId }}"
                                        ...
                                        @dragstart.stop="
                                            ...
                                            $event.dataTransfer.setData('atributo-id', '{{ $atributoId }}');
                                        "
                                        ...
                                        @drop.prevent.stop="
                                            const origen = parseInt(
                                                $event.dataTransfer.getData('atributo-id')
                                            );

                                            const destino = {{ $atributoId }};

                                            if (origen !== destino) {
                                                $wire.reordenarAtributos(origen, destino);
                                            }
                                        "
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <button
                                                type="button"
                                                wire:click.stop="moverAtributoArriba({{ $atributoId }})"
                                                @disabled($loop->first)
                                                @class([
                                                    'inline-flex h-7 w-7 items-center justify-center rounded border text-sm transition',
                                                    'border-gray-200 bg-white text-gray-600 hover:bg-gray-100' => !$loop->first,
                                                    'cursor-not-allowed border-gray-100 bg-gray-50 text-gray-300' => $loop->first,
                                                ])
                                                title="Mover atributo arriba"
                                            >
                                                ▲
                                            </button>
                                            ...
                                            <button
                                                type="button"
                                                wire:click.stop="moverAtributoAbajo({{ $atributoId }})"
                                                @disabled($loop->last)
                                                @class([
                                                    'inline-flex h-7 w-7 items-center justify-center rounded border text-sm transition',
                                                    'border-gray-200 bg-white text-gray-600 hover:bg-gray-100' => !$loop->last,
                                                    'cursor-not-allowed border-gray-100 bg-gray-50 text-gray-300' => $loop->last,
                                                ])
                                                title="Mover atributo abajo"
                                            >
                                                ▼
                                            </button>
                                            ...
                                            <button
                                                type="button"
                                                wire:click.stop="eliminarAtributo({{ $atributoId }})"
                                                class="ml-1 text-sm font-medium text-red-600 transition hover:text-red-800"
                                            >
                                                Eliminar
                                            </button>
                                        </div>
                                            ...
                                            >
                                                ...
                                                @foreach($card['valores'] as $valorId => $valor)
                                                    ...
                                                    {{-- ==================================
                                                        ...
                                                        ================================== --}}
                                                    <li
                                                        wire:key="categoria-atributo-{{ $atributoId }}-valor-{{ $valorId }}"
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <button
                                                                type="button"
                                                                wire:click.stop="moverValorArriba({{ $atributoId }}, {{ $valorId }})"
                                                                @disabled($loop->first)
                                                                @class([
                                                            ...
                                                            <button
                                                                type="button"
                                                                wire:click.stop="moverValorAbajo({{ $atributoId }}, {{ $valorId }})"
                                                                @disabled($loop->last)
                                                                @class([
                                                                    'inline-flex h-7 w-7 items-center justify-center rounded border text-xs transition',
                                                                    'border-gray-200 bg-white text-gray-600 hover:bg-gray-100' => !$loop->last,
                                                            ...
                                                            <button
                                                                type="button"
                                                                wire:click.stop="eliminarValor({{ $atributoId }}, {{ $valorId }})"
                                                                class="ml-1 text-sm font-medium text-red-600 transition hover:text-red-800"
                                                            >
                                                                Quitar
                                                            </button>
                            ...
                            <div class="space-y-8 p-4">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        >
                                            Agregue un atributo que todavía no pertenece a la categoría.
                                        </p>
                                    ...
                                    <div class="w-full">
                                        ...
                                        <label
                                            for="categoria-atributo-selector"
                                        ...
                                        <select
                                            id="categoria-atributo-selector"
                                            ...
                                            @if(!empty($availableValores))
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    @foreach($availableValores as $valorId => $valorData)
                                                        ...
                                                        <label
                                                            wire:key="atributo-nuevo-valor-{{ $selectedAtributoId }}-{{ $valorId }}"
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p
                                            class="mt-1 text-xs text-gray-500"
                                        >
                                            Seleccione un atributo de la categoría para agregarle
                                            valores adicionales.
                                        </p>
                                    ...
                                    <div class="w-full">
                                        ...
                                        <label
                                            for="categoria-atributo-existente-selector"
                                            class="mb-1 block text-sm font-medium text-gray-700"
                                        >
                                            Atributo
                                        </label>
                                        ...
                                        <select
                                            id="categoria-atributo-existente-selector"
                                            ...
                                            @if(!empty($availableExistingValores))
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    @foreach($availableExistingValores as $valorId => $valorData)
                                                        ...
                                                        <label
                                                            wire:key="atributo-existente-valor-{{ $selectedExistingAtributoId }}-{{ $valorId }}"
                                                            @class([
